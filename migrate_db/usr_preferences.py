#!/usr/bin/python2.3
#
# $Id: usr_preferences.py,v 1.5 2008/08/26 12:21:30 janakj Exp $
#
...
def convert_usr_preferences(dst, src):
    ...
    for up in ups:
        ...
        try:
            ...
            print "Conflicting row found in user_attrs table (%s, %s, %s, %s, %s)" % (uid, attribute, type, value, common.DB_LOAD_SER | common.DB_FOR_SERWEB)
            pass
